                        ...
                        @forelse ($inventaris as $item)
                            <tr class="hover:bg-white/50 transition-all duration-200 group">
                                ...
                                <td class="relative whitespace-nowrap py-4 pl-3 pr-6 text-right text-sm font-medium">
                                    <a href="{{ route('inventaris.show_grouped', ['nama_barang' => $item->nama_barang]) }}" class="inline-flex items-center text-indigo-600 hover:text-indigo-800 group-hover:scale-105 transition-all duration-200 font-semibold">
