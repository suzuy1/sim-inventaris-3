...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div class="mb-8">
        <div class="flex flex-col md:flex-row md:items-center md:justify-between">
            ...
            <div class="flex flex-wrap gap-3">
                <a href="{{ route('rooms.create') }}" class="group inline-flex items-center gap-3 rounded-xl bg-gradient-to-r from-indigo-600 to-purple-600 px-5 py-3.5 text-sm font-bold text-white shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 transition-all duration-300">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        ...
        <div class="group bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg border border-gray-200/50 p-6 hover:shadow-2xl transform hover:-translate-y-1 transition-all duration-300">
            <div class="flex items-center">
                ...
                <div class="ml-5">
                    <p class="text-sm font-semibold text-gray-500 mb-1">Total Ruangan</p>
                    <p class="text-3xl font-bold text-gray-900">{{ $rooms->total() }}</p>
                    <p class="text-xs text-gray-400 mt-1">Semua ruangan terdaftar</p>
                </div>
            </div>
        ...
        <div class="group bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg border border-gray-200/50 p-6 hover:shadow-2xl transform hover:-translate-y-1 transition-all duration-300">
            <div class="flex items-center">
                ...
                <div class="ml-5">
                    <p class="text-sm font-semibold text-gray-500 mb-1">Lokasi Terisi</p>
                    <p class="text-3xl font-bold text-gray-900">{{ $rooms->where('lokasi', '!=', null)->count() }}</p>
                    <p class="text-xs text-gray-400 mt-1">Dengan lokasi spesifik</p>
                </div>
            </div>
            <div class="mt-4 pt-4 border-t border-gray-100">
        ...
        <div class="group bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg border border-gray-200/50 p-6 hover:shadow-2xl transform hover:-translate-y-1 transition-all duration-300">
            <div class="flex items-center">
                ...
                <div class="ml-5">
                    <p class="text-sm font-semibold text-gray-500 mb-1">Unit Terkait</p>
                    <p class="text-3xl font-bold text-gray-900">{{ $rooms->unique('unit_id')->count() }}</p>
                    <p class="text-xs text-gray-400 mt-1">Unit berbeda</p>
                </div>
            </div>
            <div class="mt-4 pt-4 border-t border-gray-100">
    ...
    <!-- Rooms Table dengan Enhanced Design -->
        ...
        <div class="bg-gradient-to-r from-gray-50 to-slate-50 px-6 py-5 border-b border-gray-200/50">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-sm text-gray-600 mt-1">Semua ruangan yang terdaftar dalam sistem inventaris kampus</p>
                </div>
        ...
        <div class="overflow-x-auto">
            <table class="min-w-full divide-y divide-gray-200/50">
                <thead class="bg-gray-50/80">
                    <tr>
                        <th scope="col" class="px-6 py-4 text-left text-xs font-bold text-gray-700 uppercase tracking-wider">Ruangan</th>
                        <th scope="col" class="px-6 py-4 text-left text-xs font-bold text-gray-700 uppercase tracking-wider">Lokasi</th>
                        <th scope="col" class="px-6 py-4 text-left text-xs font-bold text-gray-700 uppercase tracking-wider">Unit</th>
                ...
                <tbody class="bg-white/50 divide-y divide-gray-200/30">
                    ...
                    <tr class="hover:bg-gray-50/80 transition-all duration-200 group">
                        <td class="px-6 py-5 whitespace-nowrap">
                            <div class="flex items-center">
                                <div class="bg-gradient-to-br from-indigo-100 to-purple-100 text-indigo-600 p-3 rounded-xl mr-4 shadow-sm">
                                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"/>
                                    </svg>
                                </div>
                                <div>
                                    <div class="text-base font-bold text-gray-900 group-hover:text-gray-700">{{ $room->nama_ruangan }}</div>
                                    <div class="text-xs text-gray-500 font-mono mt-1">ID: {{ $room->id }}</div>
                                </div>
                            </div>
                        </td>
                        <td class="px-6 py-5">
                        ...
                        <td class="px-6 py-5 whitespace-nowrap">
                            <div class="flex items-center">
                                @if($room->unit)
                                <div class="bg-gradient-to-r from-green-100 to-emerald-100 text-green-800 text-sm font-bold px-3 py-1.5 rounded-full border border-green-200 shadow-sm">
                                    {{ $room->unit->nama_unit }}
                                </div>
                                @else
                                <span class="text-sm text-gray-500 bg-gray-100 px-3 py-1.5 rounded-full border border-gray-200">Tidak terhubung</span>
                                @endif
                            </div>
                        </td>
                        <td class="px-6 py-5 whitespace-nowrap">
                            <span class="inline-flex items-center px-3 py-1.5 rounded-full text-xs font-bold bg-gradient-to-r from-green-100 to-emerald-100 text-green-800 border border-green-200 shadow-sm">
                    ...
                    <tr>
                        <td colspan="5" class="px-6 py-16 text-center">
                            <div class="flex flex-col items-center justify-center">
                                <div class="bg-gradient-to-br from-gray-100 to-gray-200 text-gray-400 p-6 rounded-2xl mb-5 shadow-sm">
                                    <svg class="w-16 h-16" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"/>
                                    </svg>
                                </div>
                                <p class="text-xl font-bold text-gray-900 mb-3">Belum ada ruangan</p>
                                <p class="text-gray-500 mb-6 max-w-md">Mulai dengan menambahkan ruangan pertama Anda untuk mengelola inventaris kampus</p>
                                <a href="{{ route('rooms.create') }}" class="group inline-flex items-center gap-3 rounded-xl bg-gradient-to-r from-indigo-600 to-purple-600 px-6 py-3.5 text-sm font-bold text-white shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 transition-all duration-300">
                                    <svg class="w-5 h-5 group-hover:scale-110 transition-transform duration-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6"/>
                                    </svg>
